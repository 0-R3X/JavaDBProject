...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        setTitle("Login Form");
        setSize(400, 220); // Increased the height for larger fields
        ...
        usernameField.setPreferredSize(new Dimension(200, 25)); // Increased the size

        passwordField = new JPasswordField();
        passwordField.setPreferredSize(new Dimension(200, 25)); // Increased the size
        ...
        constraints.gridx = 0;
        constraints.gridy = 2;
        constraints.gridwidth = 2; // Span two columns for the login button
